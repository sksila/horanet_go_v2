odoo.define('horanet_web.better_gauge', function (require) {
    "use strict";

    var core = require('web.core');
    var AbstractField = require('web.AbstractField');
    var fields_registry = require('web.field_registry');
    ...
    var BetterGaugeWidget = AbstractField.extend({
        className: "oe_gauge",
    ...
    fields_registry.add("better_gauge", BetterGaugeWidget);
