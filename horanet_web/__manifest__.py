{
    ...
    'summary': 'Ressources Javascript et CSS communes aux modules Horanet (côté backoffice)',
    ...
    'category': 'Tools',  # Theme category is used for website's themes
    #
    ...
    # always loaded
    'qweb': [
        'templates/qweb/widget_list_button_redirect.xml',
    ],
    ...
    'data': [
        ...
        'templates/web_assets_common.xml',

        'views/inherited_report_layouts.xml',
    ],
