{
    ...
    'name': "Horanet Environment",
    # Version, "odoo.min.yy.m.d"
    'version': '11.0.18.12.26',
    # Short description (with keywords)
    'summary': "Contient les modèles de base d'une gestion de l'environement",
    ...
    'depends': [
        ...
        # --- External --- #
        # --- Horanet --- #
        'horanet_subscription',  # for application_type, partner_category
    ],
    # always loaded
    'css': [],
    'qweb': [],
