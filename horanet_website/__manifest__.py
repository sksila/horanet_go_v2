{
    ...
    'name': "Horanet Website",
    # Version, "odoo.min.yy.m.d"
    'version': '10.0.17.1.30',
    # Short description (with keywords)
    'summary': """Ressources Javascript et CSS communes aux modules Horanet (côté frontoffice)""",
    'author': "Horanet",
    ...
    'data': ['templates/web_assets_frontend.xml', ],
