...
def migrate(cr, version):
    ...
    We add the data of fields 'National prefix' and 'mobile prefix' to normalize phone in the international format.
    """
    logger.info('Migration started: migrating countries.')
    ...
    countries_prefix_5 = countries.filtered(
        lambda r: r.code in ['DZ', 'SA', 'DK', 'AE', 'EE', 'FI', 'HK', 'IL', 'PL', 'SI',
                             'TN', 'TK'])
    ...
    logger.info('Migration ended: countries migrated.')
