...
def migrate(cr, version):
    ...
    with api.Environment.manage():
        ...
        for assignation in assignations:
            ...
            same_period_assignation = assignation_model.search([
                ('id', '!=', assignation.id),
                ('start_date', '>', assignation.start_date),
            ...
            assignation.write({
                'end_date': same_period_assignation and same_period_assignation.start_date or new_end_date
            })
