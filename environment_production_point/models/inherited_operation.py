...
class PartnerMoveInheritedOperation(models.Model):
    ...
    def _search_operation_partner_id(self, operator, value):
        u"""Override of the search method of operation_partner_id.

        Add search method to find operation if the tag is assigned to a move
        ...
        """
        inherited_domain = super(PartnerMoveInheritedOperation, self)._search_operation_partner_id(operator, value)
    ...
    def get_operation_linked_packages(self, force_time=False):
        ...
        return super(PartnerMoveInheritedOperation, self).get_operation_linked_packages(force_time=force_time)
